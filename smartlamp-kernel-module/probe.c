...
#define VENDOR_10c4   SUBSTITUA_PELO_VENDORID /* Encontre o VendorID  do smartlamp */
#define PRODUCT_ea60  SUBSTITUA_PELO_PRODUCTID /* Encontre o ProductID do smartlamp */
